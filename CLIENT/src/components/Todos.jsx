...
function Todos() {
  ...
  const handleNote = async (e) => {
    ...
    try {
      const response = await fetch(`https://todo-server-liard-omega.vercel.app/api/todo/notes/addnote`, {
        method: "POST",
        headers: {
  ...
  const getCurrNote = async () => {
    try {
      const response = await fetch(`https://todo-server-liard-omega.vercel.app/api/todo/notes/gettodo/${date}/${user._id}`, {
        method: "GET",
        headers: {
          Authorization: authoriztionToken,
        }
  ...
  const handleDeleteNoteById = async (id) => {
    try {
      const response = await fetch(`https://todo-server-liard-omega.vercel.app/api/todo/notes/delete/${id}`, {
        method: "POST",
        headers: {
          Authorization: authoriztionToken
        }
  ...
  const handleEditNoteById = async (id) => {
    ...
    if (!isEditable) {
      ...
      try {
        const response = await fetch(`https://todo-server-liard-omega.vercel.app/api/todo/notes/update/${id}`, {
          method: "PATCH",
          headers: {
            "Content-Type" : "application/json",
            Authorization: authoriztionToken,
  ...
  const handleNoteCompleted = async(id) => {
    try {
      const response = await fetch(`https://todo-server-liard-omega.vercel.app/api/todo/notes/complete/${id}`, {
        method: "POST",
        headers: {
          Authorization: authoriztionToken
        },
